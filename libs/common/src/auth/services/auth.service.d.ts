...
export declare class AuthService implements IAuthService {
    ...
    constructor(databaseService: DatabaseService, helperEncryptionService: HelperEncryptionService, vietguysService: VietguysService, smsSimService: SmsSimService, emailQueue: Queue);
